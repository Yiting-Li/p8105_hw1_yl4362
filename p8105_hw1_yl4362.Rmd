...
```
After applying `{r as.numeric}`, results of 'samp', 'samp_gt_0', and 'factor_vec' were successfully converted to numeric values because factor vector is used to refer to a qualitative relationship.  But it does not work for character vector because they are combinations of letters.
